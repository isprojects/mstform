...
export class RepeatingForm<TFormDefinition extends FormDefinitionType> {
...
export type FormDefinitionType = {
  [key: string]: Field<any, any> | RepeatingForm<any>;
};
...
export type RepeatingFormProps<T> = {
...
export class FormState<TFormDefinition extends FormDefinitionType> {
  ...
  access<K extends keyof FieldProps<TFormDefinition>>(
    name: K
  ): FieldAccessor<
    TFormDefinition,
    Extract<TFormDefinition[K], Field<any, any>>,
    TFormDefinition[K] extends Field<any, any>
...
export class RepeatingFormAccessor<
  TFormDefinition extends FormDefinitionType,
  TRepeatingFormDefinition extends FormDefinitionType
> {
  private state: FormState<TFormDefinition>;
  form: Form<TRepeatingFormDefinition>;
  path: string;
  ...
  index(
    index: number
  ): RepeatingFormIndexAccessor<TFormDefinition, TRepeatingFormDefinition> {
    return new RepeatingFormIndexAccessor(
      this.state,
      this.form,
      this.path,
      index
...
export class RepeatingFormIndexAccessor<
  TFormDefinition extends FormDefinitionType,
  TRepeatingFormDefinition extends FormDefinitionType
> {
  private state: FormState<TFormDefinition>;
  ...
  access<K extends keyof FieldProps<TRepeatingFormDefinition>>(
    name: K
  ): FieldAccessor<
    TFormDefinition,
    TRepeatingFormDefinition[K],
    TRepeatingFormDefinition[K]["rawType"],
    TRepeatingFormDefinition[K]["valueType"]
  > {
    return new FieldAccessor(this.state, this.form.definition[name], name);
  }
